    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-12 content">
                        <form method="POST" action="${pageContext.request.contextPath}/admin/AdminProvidersServlet" name="filter">
                            <div class="row">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/admin/AdminProvidersServlet" name="Tabl">
                            <div class="row">
                                <div class="col-md-12" style="height: 330px; overflow-y: auto;">
                                    <c:choose>
                                        <c:when test="${filtered==null}">
                                            <display:table id="tblMain" name="<%= new ProviderController().getAll(false)%>">
                ...
                <form method="POST" action="${pageContext.request.contextPath}/admin/AdminProvidersServlet" name="Demo">
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/admin/AdminProvidersServlet">
