                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <c:choose>
                                    <c:when test="true">
                                        <label for="taken_action">Acción tomada:</label>
                                    </c:when>
                                    <c:otherwise>
                                        <label for="taken_action" class="text-danger">Error</label>
                                    </c:otherwise>
                                </c:choose>
                                <select class="form-control" name="taken_action" id="taken_action">
                                    <option value="0">Remitir con autoridad competente</option>
                                    <option value="1">Tomar contacto con ISP y colegio</option>
                                </select>
                            </div>
                        </div>
                    </div>
